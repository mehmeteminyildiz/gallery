package com.example.mygallery.test
...
import com.example.mygallery.databinding.ActivityTestBinding
...
class TestActivity : AppCompatActivity() {
    ...
    private fun setupExternalStorageRecyclerView() = binding.rvImages.apply {
